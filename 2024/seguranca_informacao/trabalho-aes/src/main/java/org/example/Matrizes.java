...
public class Matrizes {
    ...
    public static final int[][] TABELA_E = {
    ...
    public static final int[][] TABELA_L = {
    ...
    public static int getSboxValor(int decimal) {
        int[] linhaColuna = getLinhaColuna(decimal);
        // & 0xFF Converte em um inteiro sem sinal, ou seja, retorna a representação do hexadecimal na SBOX, em decimal.
        return SBOX[linhaColuna[0]][linhaColuna[1]] & 0xFF;
    };

    public static int getTabelaLValor(int decimal) {
        int[] linhaColuna = getLinhaColuna(decimal);
        // & 0xFF Converte em um inteiro sem sinal, ou seja, retorna a representação do hexadecimal na SBOX, em decimal.
        return TABELA_L[linhaColuna[0]][linhaColuna[1]] & 0xFF;
    };

    public static int getTabelaEValor(int decimal) {
        int[] linhaColuna = getLinhaColuna(decimal);
        // & 0xFF Converte em um inteiro sem sinal, ou seja, retorna a representação do hexadecimal na SBOX, em decimal.
        return TABELA_E[linhaColuna[0]][linhaColuna[1]] & 0xFF;
    };

    private static int[] getLinhaColuna(int decimal) {
